...
const en: Dict = {
  ...
  "settings.deploy.subtitle":
    "Publish the generated HTML to a public URL with one click. Tokens stay on your machine in ~/.huoll-editor (chmod 600).",
...
const zhCN: Dict = {
  ...
  "settings.deploy.subtitle":
    "把生成好的 HTML 一键发布成公网链接。Token 仅本地保存于 ~/.huoll-editor（chmod 600）。",
  "settings.deploy.vercel.title": "Vercel",
  "settings.deploy.vercel.tokenLabel": "API Token",
  "settings.deploy.vercel.tokenPlaceholder": "vercel_xxx…",
  "settings.deploy.vercel.tokenHint":
