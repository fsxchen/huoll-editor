...
- App dev: `pnpm -F huoll-editor dev`
- App typecheck: `pnpm -F huoll-editor typecheck`
- App unit tests: `pnpm -F huoll-editor test`
- App build: `pnpm -F huoll-editor build`
- E2E typecheck: `pnpm -F @huoll-editor/e2e typecheck`
- E2E tests: `pnpm -F @huoll-editor/e2e test`
