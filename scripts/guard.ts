...
requireText("e2e/playwright.config.ts", "pnpm -F huoll-editor build");
...
requireText(".github/workflows/ci.yml", "pnpm -F huoll-editor typecheck");
requireText(".github/workflows/ci.yml", "pnpm -F @huoll-editor/e2e typecheck");
requireText(".github/workflows/ci.yml", "pnpm -F huoll-editor test");
requireText(".github/workflows/ci.yml", "pnpm -F huoll-editor build");
requireText(".github/workflows/ci.yml", "pnpm -F @huoll-editor/e2e exec playwright install --with-deps chromium");
requireText(".github/workflows/ci.yml", "pnpm -F @huoll-editor/e2e test");
